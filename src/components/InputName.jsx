  ...
  return hasName ? (
    <>
      ...
      <div className="absolute hizala w-full h-1/4 items-center justify-center flex rounded-xl md:w-1/2 flex-col">
        <p className="text-xl text-center top-0 absolute">Hoşgeldin!</p>
        ...
        <input
          ...
          type="text"
          id="user-name"
          className=" mt-8 block w-3/4 p-4 ps-5 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
